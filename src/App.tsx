...
import { Code, Lightbulb, RefreshCw, Compass, Users, PhoneOff, BarChart3, Target, Zap, ShieldCheck, TrendingUp, Layout, FileSpreadsheet, Instagram, Megaphone, Share2, Globe, PenTool, Video, Star, Play, Quote, MessageSquare, Menu, X } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white font-sans selection:bg-purple-500/30" id="home">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0c]/80 backdrop-blur-md border-b border-white/5">
        ...
        <motion.div 
          ...
          className="md:hidden overflow-hidden bg-[#0d0d12] border-b border-white/10"
        >
      ...
      {/* Hero Section */}
      <main className="relative pt-32 pb-20 px-6 md:px-8 max-w-7xl mx-auto overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <a 
                  href="https://wa.me/917815951361"
                  target="_blank"
                  rel="noreferrer"
                  className="w-full sm:w-auto px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl font-medium transition-all group active:scale-95 flex items-center justify-center gap-2"
                >
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full sm:w-auto px-8 py-4 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/20 rounded-xl font-medium transition-all text-[#25D366] active:scale-95 flex items-center justify-center gap-2"
                >
        ...
        <section className="mt-32 md:mt-40">
          <motion.h2 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-12 md:mb-20 tracking-tight"
          >
        ...
        {/* Results Section */}
        <section className="mt-32 md:mt-60 border-y border-white/5 py-20 md:py-32 bg-white/[0.01]">
          <div className="max-w-7xl mx-auto px-6 md:px-8 text-center">
            <motion.h2 
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="text-sm font-bold uppercase tracking-[0.3em] text-indigo-500 mb-12 md:mb-20"
            >
              Results Section
            </motion.h2>
        ...
        <section className="mt-32 md:mt-60 px-6 md:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 md:mb-16">
            <div>
              <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-indigo-500 mb-4">Success Stories</h2>
              <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">Case Studies</h3>
            </div>
        ...
        <section id="services" className="mt-32 md:mt-60 px-6 md:px-8 max-w-7xl mx-auto">
        ...
        <section className="mt-32 md:mt-60 pb-20">
          <div className="max-w-7xl mx-auto px-8 text-center mb-12 md:mb-20">
            <motion.h2 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
        ...
        {/* Experience Section */}
        <section id="about" className="mt-32 md:mt-60 max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-24 bg-white/[0.02] rounded-[2.5rem] md:rounded-[4rem] border border-white/5 overflow-hidden relative">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <motion.span 
                ...
                whileInView={{ opacity: 1 }}
                viewport={{ once: true }}
                className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.4em] text-indigo-500 mb-6 block"
              >
                Our Legacy
              </motion.span>
              ...
              <p className="text-lg md:text-xl text-gray-400 mb-8 md:mb-10 leading-relaxed italic border-l-4 border-indigo-500/30 pl-4 md:pl-6">
        ...
        {/* Final CTA Section */}
        <section id="contact" className="mt-32 md:mt-60 pb-20 md:pb-40 px-6 md:px-8">
          <motion.div 
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 via-purple-600 to-indigo-500 rounded-[2.5rem] md:rounded-[4rem] blur-xl opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200" />
            
            <div className="relative bg-[#0a0a0f] border border-white/10 rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-24 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 md:mb-8 tracking-tighter leading-tight md:leading-none">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                  <motion.a 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-10 py-5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl transition-all shadow-[0_20px_50px_rgba(79,70,229,0.3)] hover:shadow-indigo-500/50 flex items-center gap-3 group/btn cursor-pointer"
                  >
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-12 md:gap-y-16 mt-24 md:mt-40 border-t border-white/5 pt-16 md:pt-20"
        >
          <FeatureCard 
...
function TestimonialCarousel() {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto px-4 overflow-hidden min-h-[500px] md:h-[450px] flex items-center">
      <div 
        className="flex transition-transform duration-1000 ease-in-out h-full"
        style={{ transform: `translateX(-${currentIndex * 100}%)` }}
      >
        {testimonials.map((t, i) => (
          <div key={i} className="min-w-full h-full flex items-center justify-center p-2 md:p-4">
            <div className="bg-[#121218] border border-white/5 p-8 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] w-full max-w-3xl relative overflow-hidden group hover:border-indigo-500/20 transition-colors">
              <Quote className="absolute top-12 right-12 w-16 md:w-24 h-16 md:h-24 text-white/5 -rotate-12" />
              ...
              <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-10">
                ...
                <div>
                  <h4 className="text-lg md:text-xl font-bold text-white">{t.title}</h4>
                  <p className="text-[10px] text-gray-500 uppercase tracking-[0.2em] font-black">{t.client}</p>
                </div>
              </div>

              <p className="text-xl md:text-3xl font-medium text-gray-200 leading-snug mb-8 md:mb-10">
                "{t.content}"
              </p>
...
function StatItem({ targetValue, prefix = "", suffix = "", label }: { targetValue: number, prefix?: string, suffix?: string, label: string }) {
  ...
  return (
    ...
    >
      <div className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tighter text-white">
        {prefix}{count}{suffix}
      </div>
